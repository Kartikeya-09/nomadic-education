    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        .auth-container {
            ...
            z-index: 1; background: transparent; /* Removed solid background */
        ...
        .signup-panel { 
            ...
            padding: 0 10% 0 15%;
            /* Fades the background to transparent on the left edge */
        ...
        .video-card {
            ...
            /* Apple-Level Crossfade: Smoothly fades the edges of the video */
            -webkit-mask-image: linear-gradient(to right, transparent 0%, black 10%, black 90%, transparent 100%);
            mask-image: linear-gradient(to right, transparent 0%, black 10%, black 90%, transparent 100%);
            -webkit-mask-size: 200% 100%;
            mask-size: 200% 100%;
            -webkit-mask-position: 0% 0%; /* Shows left half: fades left edge */
            mask-position: 0% 0%;
        }
        
        body.is-signup .video-card { 
            left: 0; 
            -webkit-mask-position: 100% 0%; /* Smoothly animates to fade the right edge */
            mask-position: 100% 0%;
        }
        ...
        .btn-primary:hover { background: var(--primary); transform: translateY(-2px); box-shadow: 0 15px 30px rgba(251, 191, 36, 0.4); }
        ...
        <div class="form-panel login-panel">
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div style="text-align: right; margin-bottom: 25px;">
                    <a href="#" style="color: var(--primary); font-size: 0.95rem; font-weight: 600; text-decoration: none;">Forgot password?</a>
                </div>
